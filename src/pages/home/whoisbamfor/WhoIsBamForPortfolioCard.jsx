...
import whoisbam1 from '../../../assets/images/home/whoisbam1.png';
import whoisbam2 from '../../../assets/images/home/whoisbam2.png';
import whoisbam3 from '../../../assets/images/home/whoisbam3.png';
import whoisbam4 from '../../../assets/images/home/whoisbam4.png';
import whoisbam5 from '../../../assets/images/home/whoisbam5.png';
...
const WhoIsBamForPortfolioCard = () => {
  return (
    <div className="flex h-[300px] mt-80 xl:mt-0 sm:h-screen w-screen shrink-0 flex-col justify-center sm:justify-between bg-[#BD0308] px-6 py-16 text-white sm:px-10 sm:py-24 2xl:px-80 xl:py-40">
      <div className="flex flex-1 gap-2 sm:gap-5">
        ...
        <div className="relative flex h-full min-w-0 flex-[0.8] flex-col overflow-hidden rounded-xl sm:min-w-[280px]">
          ...
          <div className="relative mt-auto flex flex-col items-center justify-center rounded-t-xl bg-black/50 px-1 py-2 sm:px-5 sm:py-5 text-center backdrop-blur-xl sm:px-8 sm:py-8">
            <p className="text-xs font-semibold text-white xl:text-[36px]">Laila Ramesh</p>
            <p className="mt-1 text-[10px] text-white/70 xl:text-[18px] font-medium flex justify-center items-center gap-1 ">
            ...
            <div className="mt-2 xl:mt-4 flex items-center justify-center gap-3 sm:mt-5">
              <button className="rounded-xl bg-[#444649] px-2 py-1 sm:px-4 sm:py-2 text-[8px] font-semibold text-white backdrop-blur sm:px-6 sm:text-sm">
                Follow
              </button>
              <button className="rounded-xl bg-[#BD0308] px-2 py-1 sm:px-4 sm:py-2 text-[8px] font-semibold text-white sm:px-6 sm:text-sm">
                +&nbsp;Interest
              </button>
            </div>
          </div>
        ...
        <div
          className="flex min-w-0 flex-1 flex-col gap-2 sm:gap-5 sm:min-w-[280px]"
      ...
      <div className="mt-6 max-w-3xl sm:mt-8">
        <p className="text-[14px] font-[500] leading-snug sm:text-[28px] xl:text-[36px]">
